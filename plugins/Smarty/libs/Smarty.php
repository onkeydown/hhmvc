...
class Smarty extends Smarty_Internal_TemplateBase
{
    ...
    public function __construct()
    {
        ...
        // set default dirs
        $this->setTemplateDir(ROOT_DIR . 'public' . DS . 'themes' . DS . 'default')
            ->setCompileDir(ROOT_DIR . 'cache' . DS . 'templates_c' . DS)
            ->setPluginsDir(SMARTY_PLUGINS_DIR)
            ->setCacheDir(ROOT_DIR . 'cache' . DS)
            ->setConfigDir(ROOT_DIR . 'configs' . DS);
